...
class MachineStatus extends $pb.ProtobufEnum {
  ...
  static const MachineStatus MACHINE_STATUS_ONLINE =
      MachineStatus._(1, _omitEnumNames ? '' : 'MACHINE_STATUS_ONLINE');
  static const MachineStatus MACHINE_STATUS_OFFLINE =
      MachineStatus._(2, _omitEnumNames ? '' : 'MACHINE_STATUS_OFFLINE');
