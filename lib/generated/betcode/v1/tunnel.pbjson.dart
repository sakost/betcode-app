...
const TunnelErrorCode$json = {
  ...
  '2': [
    ...
    {'1': 'TUNNEL_ERROR_CODE_INVALID_ARGUMENT', '2': 6},
  ],
};
...
final $typed_data.Uint8List tunnelErrorCodeDescriptor = $convert.base64Decode(
    ...
    '9ERV9VTkFVVEhPUklaRUQQBBIhCh1UVU5ORUxfRVJST1JfQ09ERV9VTkFWQUlMQUJMRRAFEiYK'
    'IlRVTk5FTF9FUlJPUl9DT0RFX0lOVkFMSURfQVJHVU1FTlQQBg==');
